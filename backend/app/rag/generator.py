...
- 답변 마지막은 반드시 다음 형식으로 끝내세요: "[참조 문서에서 아직 다루지 않은 관련 후속 질문]? 혹은 제안요청서(RFP)를 작성하시겠습니까?"
- 후속 질문은 참조 문서에 실제 설명이 있는 주제로만 만드세요.
- 예시: "직급별 차량 등급 기준에 대해서도 알려드릴까요? 혹은 제안요청서(RFP)를 작성하시겠습니까?"
- 예시: "운용리스와 금융리스의 회계 처리 차이도 궁금하십니까? 혹은 제안요청서(RFP)를 작성하시겠습니까?"
