...
TAXONOMY = {
    "건물 관리": ["건물 관리 용역 서비스(청소/보안/방역/시설점검)", "비품 구매/렌탈(공기청정기/정수기/복합기/비데/OA기기 렌탈·리스)"],
    "마케팅": ["판촉물", "디지털 광고(바이럴마케팅/SNS/블로그/인플루언서/키워드광고/SEO/배너광고)", "매장 관리", "시장 조사 용역", "일반 광고(TV/라디오/신문/PPL)", "전자시장정보", "판매 도급", "행사 관리", "홍보(홍보대행/기사모니터링)", "스폰서"],
    ...
    "비품/소모품": ["공장용 소모품", "근무복", "사무용가구", "사무용품(문구/용지/소모재)", "생수", "도서", "전자기기(일회성 구매)"],
