...
할인 조건, 협상 포인트가 있으면 포함하세요.""",
    ...
    "hot": """[모드: 역제안]
400~700자. 구매 담당자의 파트너로서 능동적으로 비용 절감 전략을 제안하세요.
- 사용자가 구체적 조건(예산/수량)을 제시했으면: 참조 문서 수치 기반으로 적극 역제안.
- 구매 의사만 표현했으면: 참조 문서의 핵심 수치 2~3개 제시 후 "예산, 필요 대수, 계약 기간을 알려주시면 맞춤 절감 전략을 제안해 드리겠습니다."로 마무리.
